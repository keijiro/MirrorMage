# Redesigning Wizard Barrier Magic Sprite

## User

このスプライト素材を作り直したいと思います。魔法使いが展開する結界のスプライトで、青白い魔法陣を描いたものです。64-bit Pixel (ModelId: 245801a2-f850-4f09-9cee-9ef74c5872a6) を使用するようにしてください。
